...
const UpdateJob = () => {
  ...
  const{_id, jobTitle, companyName, minPrice, maxPrice, salaryType,companyLogo, experienceLevel,employmentType, description} = useLoaderData;
    ...
    const onSubmit = async (data) => {
      ...
      try {
        const response = await fetch(`http://localhost:3000/date-job/${id}`, {
          method: "PATCH",
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <div>
            ...
            <select {...register("experienceLevel")} className='create-job-input'>
              <option value={experienceLevel}>Choose Experience Level</option>
